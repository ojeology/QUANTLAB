"""
FILTER SWEET-SPOT HUNT incl. 2023 — find config surviving 2024/2025/2026.

Fetches 2023 live (cache starts 2024), so 2024 becomes testable (train on 2023).
Sweeps q x VolCeil x breadth50, walk-forward per year, flags PF@cost>1 in ALL of 2024/2025/2026.
Subset universe (liquid ~30) for feasible 2023 fetch. Fees 0.05%.
"""
...
print("\n" + "=" * 96)
print("SWEET-SPOT HUNT incl 2023 (train 2023 -> test 2024/25/26)  PF@cost per year")
print("=" * 96)
...
print("\n=== SURVIVORS (PF@cost > 1 in 2024 AND 2025 AND 2026) ===")
if survivors:
