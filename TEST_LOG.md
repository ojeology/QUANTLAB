...
- **T25. FINALIZE sized champion (SVMQ65Adaptive or RF condition-aware) into demo_bot.** Reason: only validated 3-year survivors, and RF is interpretable (reasons known). → pending.
